...
const MODULES: FabricModule[] = [
  {
    ...
    note: "Signal grid status + resonant metrics.",
  },
  {
    id: "nanodecibel",
    name: "Nanodecibel",
  ...
  },
  {
    ...
    backend: "ai-global-9999:9999 /api/v1/resonant/events",
  ...
  },
  {
    ...
    measured: true,
    alias: "/api/rezonance",
    backend: "ai-global-9999:9999 /api/v1/resonant/status",
  ...
  },
  {
    ...
    measured: true,
    alias: "/api/tide",
    backend: "ai-global-9999:9999 /api/v1/resonant/status (tide block)",
    note: "Operational gating signal.",
  },
  {
    id: "scan-print",
    ...
    note: "Scan -> reason -> emit pipeline.",
  },
  {
    id: "wwwmmm",
    name: "WWWMMM",
    status: "live",
    measured: true,
    alias: "/api/rezonance/status",
    backend: "ai-global-9999:9999 quality_gates.wwwmmm_verdict",
    note: "Orchestration + quality gate profile.",
  },
  {
    id: "os-clx",
    name: "OS-CLX",
