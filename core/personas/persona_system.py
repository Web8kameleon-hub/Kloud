...
class Persona:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "Persona":
        ...
        return cls(
            ...
            default_engine=data.get("default_engine", "clx:clx"),
...
class PersonaRegistry:
    ...
    def initialize(self) -> None:
        ...
        logger.info(
            f"✅ Persona Registry initialized with {len(self._personas)} personas"
        )
