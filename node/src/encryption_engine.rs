use security::{pq_kem_decrypt, pq_kem_encrypt, KemPublicKey, KemSecretKey};
...
impl EncryptionEngine {
    pub fn encrypt(public_key: &KemPublicKey, payload: &[u8]) -> (Vec<u8>, Vec<u8>) {
    ...
    pub fn decrypt(private_key: &KemSecretKey, ciphertext: &[u8], encrypted: &[u8]) -> Vec<u8> {
