...
OUTPUT:
  Kloud_Master_Table.xlsx - hapet automatikisht
"""
...
API_DATA = [
    {"Row_ID": "ROW-0001", "Endpoint": "/health", "Method": "GET", "Folder": "📋 Health & Status", "Description": "Kontrollon gjendjen e shëndetit të sistemit. Kthen statusin e përgjithshëm të platformës Kloud Cloud duke përfshirë versionin, uptime dhe statusin e shërbimeve të brendshme.", "Sample_Response": '{\n  "service": "kloud-cloud",\n  "status": "healthy",\n  "version": "2.1.0",\n  "uptime_seconds": 86400,\n  "timestamp": "2026-01-11T10:00:00Z",\n  "components": {\n    "database": "healthy",\n    "redis": "healthy",\n    "prometheus": "healthy"\n  }\n}', "cURL": 'curl -X GET "https://api.kloud.com/health" -H "Authorization: Bearer $TOKEN"', "Python_Snippet": 'import requests\n\nresponse = requests.get(\n    "https://api.kloud.com/health",\n    headers={"Authorization": f"Bearer {TOKEN}"}\n)\nprint(response.json())'},
    {"Row_ID": "ROW-0002", "Endpoint": "/status", "Method": "GET", "Folder": "📋 Health & Status", "Description": "Merr statusin e detajuar të sistemit duke përfshirë metrikat e CPU, RAM, disk dhe numrin e kërkesave aktive.", "Sample_Response": '{\n  "status": "operational",\n  "cpu_percent": 23.5,\n  "memory_percent": 45.2,\n  "disk_percent": 67.8,\n  "active_requests": 42\n}', "cURL": 'curl -X GET "https://api.kloud.com/status" -H "Authorization: Bearer $TOKEN"', "Python_Snippet": 'response = requests.get("https://api.kloud.com/status", headers={"Authorization": f"Bearer {TOKEN}"})'},
    {"Row_ID": "ROW-0003", "Endpoint": "/api/system-status", "Method": "GET", "Folder": "📋 Health & Status", "Description": "Kthen statusin e plotë të sistemit industrial duke përfshirë të gjitha shërbimet, metrikat dhe alarmet aktive.", "Sample_Response": '{\n  "system": "kloud-industrial",\n  "status": "running",\n  "services": {\n    "alba_network": {"status": "active"},\n    "albi_neural": {"status": "active"},\n    "jona_coordinator": {"status": "active"}\n  }\n}', "cURL": 'curl -X GET "https://api.kloud.com/api/system-status"', "Python_Snippet": 'response = requests.get("https://api.kloud.com/api/system-status")'},
    {"Row_ID": "ROW-0004", "Endpoint": "/db/ping", "Method": "GET", "Folder": "📋 Health & Status", "Description": "Teston lidhjen me bazën e të dhënave PostgreSQL.", "Sample_Response": '{"database": "postgresql", "status": "connected", "ping_ms": 2.3}', "cURL": 'curl -X GET "https://api.kloud.com/db/ping"', "Python_Snippet": 'response = requests.get("https://api.kloud.com/db/ping")'},
    {"Row_ID": "ROW-0005", "Endpoint": "/redis/ping", "Method": "GET", "Folder": "📋 Health & Status", "Description": "Teston lidhjen me Redis cache.", "Sample_Response": '{"redis": "connected", "ping": "PONG", "latency_ms": 0.8}', "cURL": 'curl -X GET "https://api.kloud.com/redis/ping"', "Python_Snippet": 'response = requests.get("https://api.kloud.com/redis/ping")'},
    {"Row_ID": "ROW-0006", "Endpoint": "/api/ask", "Method": "POST", "Folder": "🎤 Ask & Neural Symphony", "Description": "Endpoint i inteligjencës artificiale për pyetje-përgjigje.", "Sample_Response": '{"answer": "Kloud është...", "confidence": 0.95}', "cURL": 'curl -X POST "https://api.kloud.com/api/ask" -d \'{"question": "..."}\'', "Python_Snippet": 'response = requests.post("https://api.kloud.com/api/ask", json={"question": "..."})'},
    {"Row_ID": "ROW-0007", "Endpoint": "/neural-symphony", "Method": "GET", "Folder": "🎤 Ask & Neural Symphony", "Description": "Gjeneron muzikë brain-sync në kohë reale.", "Sample_Response": '{"type": "audio/wav", "duration_seconds": 300}', "cURL": 'curl -X GET "https://api.kloud.com/neural-symphony" -o symphony.wav', "Python_Snippet": 'response = requests.get("https://api.kloud.com/neural-symphony", stream=True)'},
    ...
    {"Row_ID": "ROW-0014", "Endpoint": "/asi/status", "Method": "GET", "Folder": "🤖 ASI Trinity", "Description": "Merr statusin e ASI Trinity (ALBA, ALBI, JONA).", "Sample_Response": '{\n  "trinity_status": "active",\n  "agents": {\n    "alba": {"status": "online"},\n    "albi": {"status": "online"},\n    "jona": {"status": "online"}\n  }\n}', "cURL": 'curl -X GET "https://api.kloud.com/asi/status"', "Python_Snippet": 'response = requests.get("https://api.kloud.com/asi/status")'},
    {"Row_ID": "ROW-0015", "Endpoint": "/asi/health", "Method": "GET", "Folder": "🤖 ASI Trinity", "Description": "Kontrollon shëndetin e ASI Trinity.", "Sample_Response": '{"overall_health": "healthy", "components": {...}}', "cURL": 'curl -X GET "https://api.kloud.com/asi/health"', "Python_Snippet": 'response = requests.get("https://api.kloud.com/asi/health")'},
...
def generate_master_table(output_path: str = None):
    ...
    output_path = output_path or str(base_path / "Kloud_Master_Table.xlsx")
...
if __name__ == "__main__":
    ...
    print("🎯 KLOUD MASTER TABLE GENERATOR")
    print("=" * 50)
